...
const styles = StyleSheet.create({
  ...
  category: { minHeight: 44, justifyContent: 'center', borderWidth: 1, borderRadius: 22, paddingHorizontal: 12 },
  ...
  actions: { flexDirection: 'row', flexWrap: 'wrap', gap: 9, paddingTop: 10 },
  button: { minHeight: 44, minWidth: 120, flexGrow: 1, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderRadius: 8, paddingHorizontal: 12 },
