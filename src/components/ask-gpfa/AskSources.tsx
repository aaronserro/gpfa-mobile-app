...
export default function AskSources({
  ...
  return (
    <View style={[styles.root, { borderTopColor: t.rule }]}>
      <Pressable
      ...
      >
        ...
        <Text style={[styles.count, { color: t.inkMuted, borderColor: t.rule }]}>{sources.length}</Text>
        ...
        <View style={styles.list}>
          {[...sources].sort((a, b) => a.rank - b.rank).map((source) => (
            <Pressable
              ...
              style={({ pressed }) => [
                styles.source,
                { borderColor: t.rule, backgroundColor: pressed ? t.surfaceSoft : t.surfacePage },
              ]}
            >
...
const styles = StyleSheet.create({
  ...
  heading: { flex: 1, fontFamily: sans(600), fontSize: 13.5 },
  count: { minWidth: 22, paddingHorizontal: 5, paddingVertical: 2, borderWidth: 1, borderRadius: 12, textAlign: 'center', fontFamily: mono(500), fontSize: 9.5 },
  stateCopy: { marginTop: 2, fontFamily: sans(400), fontSize: 12.5, lineHeight: 18.5 },
  ...
  sourceTitle: { fontFamily: sans(600), fontSize: 13, lineHeight: 18.5 },
  excerpt: { fontFamily: sans(400), fontSize: 12, lineHeight: 17.5 },
});
