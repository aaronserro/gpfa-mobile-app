...
/** Contract-shaped search rows spanning every source kind and rendered section. */
export const MEMBER_SEARCH_DOCUMENTS: MemberSearchResult[] = [
  {
    id: 'search-content-page',
    kind: 'content',
    title: 'Member governance handbook',
    subtitle: 'Page',
    excerpt: null,
    href: '/members/governance-handbook',
    section: 'Pages',
    badge: 'Page',
    updatedAt: null,
    workingGroupSlug: null,
  },
  {
    id: 'search-content-event',
    kind: 'content',
    title: 'Montréal liquidity roundtable',
    subtitle: 'Event',
    excerpt: 'A bilingual member session on collateral mobility across Québec and global markets.',
    href: '/members/events?event=montreal-liquidity-roundtable',
    section: 'Events',
    badge: 'Event',
  ...
  {
    id: 'search-content-podcast',
    kind: 'content',
    title: 'Collateral mobility after T+1',
    subtitle: 'Podcast',
    excerpt:
      'A detailed conversation about settlement compression, operational cut-offs, exception ownership, intraday liquidity, and the practical controls institutional teams use when a single delayed instruction can affect several markets and counterparties.',
    href: '/members/podcasts/collateral-mobility-after-t-plus-one',
    section: 'Resources & Podcasts',
    badge: 'Podcast',
    updatedAt: '2026-09-12T12:00:00.000Z',
    workingGroupSlug: null,
  },
  {
    id: 'search-member-elena',
    kind: 'member',
    title: 'Elena Rossi',
    subtitle: 'Portfolio Manager · APG',
    excerpt: 'Netherlands',
    href: '/members/directory/apg/elena-rossi',
  ...
  {
    id: 'search-organization-caisse',
    kind: 'organization',
    title: 'Caisse de dépôt et placement du Québec',
    subtitle: 'CDPQ Canada',
    excerpt: 'A global investment group based in Québec.',
    href: '/members/directory/cdpq',
    section: 'People & Organizations',
    badge: 'Organization',
  ...
  {
    id: 'collateral-liquidity',
    kind: 'working_group',
    title: 'Collateral & Liquidity',
    subtitle: 'Working Group',
    excerpt: 'Peer exchange on collateral, funding, and securities finance.',
    href: '/members/groups/collateral-liquidity',
    section: 'Working Groups',
    badge: 'Group',
    updatedAt: '2026-09-09T14:00:00.000Z',
    workingGroupSlug: 'collateral-liquidity',
  },
  {
    id: 'search-forum-discussion',
    kind: 'forum_thread',
    title: 'Intraday liquidity assumptions',
    subtitle: 'Collateral & Liquidity · Priya Nair',
    excerpt: 'Compare settlement stress assumptions before the next benchmark closes.',
    href: '/members/groups/collateral-liquidity/search-forum-discussion',
    section: 'Discussions',
    badge: 'Discussion',
  ...
  {
    id: 'search-forum-event',
    kind: 'forum_thread',
    title: 'Collateral operating model workshop',
    subtitle: 'Collateral & Liquidity · Marcus Chen',
    excerpt: 'A working session for subscribed members.',
    href: '/members/groups/collateral-liquidity/search-forum-event',
    section: 'Working Group Events',
    badge: 'Discussion',
    updatedAt: '2026-09-07T13:00:00.000Z',
    workingGroupSlug: 'collateral-liquidity',
  },
  {
    id: 'search-forum-announcement',
    kind: 'forum_thread',
    title: 'Benchmark submission window extended',
    subtitle: 'Collateral & Liquidity · GPFA Secretariat',
    excerpt: 'Members have an additional week to submit validated figures.',
    href: '/members/groups/collateral-liquidity/search-forum-announcement',
    section: 'Working Group Announcements',
    badge: 'Discussion',
  ...
  },
  {
    id: 'search-poll',
    kind: 'poll',
    title: 'Preferred settlement window',
    subtitle: null,
    excerpt: 'Choose the target window for the next pilot.',
    href: '/members/polls/search-poll',
    section: 'Polls',
    badge: 'Poll',
  ...
  },
  {
    id: 'search-job',
    kind: 'job',
    title: 'Director, Collateral Strategy',
    subtitle: 'Ontario Teachers’ Pension Plan Toronto',
    excerpt: 'Lead cross-market collateral strategy and liquidity planning.',
    href: '/members/job-board?job=search-job',
    section: 'Jobs',
    badge: 'Job',
